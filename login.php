				...
				<div class="card-wrapper">
					...
					<div class="card fat">
						<div class="card-body">
							...
							<form method="POST" class="my-login-validation" novalidate="" ng-submit="login()">
								<div class="form-group">
									<label for="email">E-Mail Address</label>
									<input id="email" type="email" class="form-control" name="email" value="" required autofocus ng-model="email">
	...
	$http.post(
	  "Functions/login.php",
	  {
		...
		'email': $scope.email		            
		  ...
		  else if($scope.response=="First Signup"){
